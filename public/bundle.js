	...
	function create_main_fragment$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				li.className = li_class_value = "line cmd:toggleIcons id:" + ctx.nodeID + " svelte-1ib8zds";
			...
			p: function update(changed, ctx) {
				...
				if ((!current || changed.nodeID) && li_class_value !== (li_class_value = "line cmd:toggleIcons id:" + ctx.nodeID + " svelte-1ib8zds")) {
	...
	function create_if_block_3(component, ctx) {
		...
		return {
			c: function create() {
				...
				setAttribute(svg, "class", "svgIcon svelte-1ib8zds");
				addLoc(svg, file$1, 8, 29, 542);
				span.className = "cont-overlays svelte-1ib8zds";
	...
	function create_if_block_4(component, ctx) {
		...
		return {
			c: function create() {
				...
				span.className = "pointer cmd:showInfo cont-info svelte-1ib8zds";
	...
	function create_if_block_2(component, ctx) {
		...
		return {
			c: function create() {
				...
				span_1.className = "pointer cmd:fitBounds cont-center svelte-1ib8zds";
				span_1.title = "Move map to this layer";
				addLoc(span_1, file$1, 11, 3, 674);
				span.className = "icons  svelte-1ib8zds";
	...
	function create_if_block_1$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				input.className = "expander expanderInput hidden svelte-1ib8zds";
				...
				span.className = span_class_value = "expander pointer cmd:toggleFolder expanderCont " + (ctx.line.content.children ? '' : 'hidden') + " svelte-1ib8zds";
			...
			p: function update(changed, ctx) {
				...
				if ((changed.line) && span_class_value !== (span_class_value = "expander pointer cmd:toggleFolder expanderCont " + (ctx.line.content.children ? '' : 'hidden') + " svelte-1ib8zds")) {
					span.className = span_class_value;
				}
	...
	function create_if_block_6(component, ctx) {
		...
		return {
			c: function create() {
				...
				span = createElement("span");
				if (if_block) if_block.c();
				input.className = "check visibility pointer cmd:toggleVisibility svelte-1ib8zds";
				setAttribute(input, "type", "checkbox");
				...
				span.className = "styleIcon gmx-style-legend svelte-1ib8zds";
	...
	function create_each_block(component, ctx) {
		...
		return {
			c: function create() {
				...
				setAttribute(svg, "role", "img");
				setAttribute(svg, "class", "svgIcon on svelte-1ib8zds");
				...
				setAttribute(svg_1, "class", "svgIcon off svelte-1ib8zds");
				addLoc(svg_1, file$1, 37, 6, 2088);
				span.className = "legendIconEye enabled pointer cmd:toggleStyle svelte-1ib8zds";
				addLoc(span, file$1, 35, 5, 1926);
				span_2.className = "styleName svelte-1ib8zds";
				addLoc(span_2, file$1, 40, 34, 2292);
				span_1.className = "legendIconCell svelte-1ib8zds";
				addLoc(span_1, file$1, 40, 5, 2263);
				div.className = "gmx-style-legend svelte-1ib8zds";
	...
	function create_if_block_8(component, ctx) {
		...
		return {
			c: function create() {
				div = createElement("div");
				if (if_block) if_block.c();
				div.className = "legend svelte-1ib8zds";
	...
	function create_if_block_5(component, ctx) {
		...
		return {
			c: function create() {
				...
				label.className = "pointer title cmd:toggleVisibility svelte-1ib8zds";
				addLoc(label, file$1, 28, 2, 1579);
				div.className = "description collapse svelte-1ib8zds";
	...
	function create_if_block_10(component, ctx) {
		...
		return {
			c: function create() {
				...
				ul.className = ul_class_value = "group css-treeview id_" + (ctx.properties ? ctx.properties.name : 'root') + " svelte-1ib8zds";
			...
			p: function update(changed, ctx) {
				...
				if ((!current || changed.properties) && ul_class_value !== (ul_class_value = "group css-treeview id_" + (ctx.properties ? ctx.properties.name : 'root') + " svelte-1ib8zds")) {
	...
	function create_main_fragment$4(component, ctx) {
		...
		return {
			c: function create() {
				...
				map._fragment.c();
				div_3.className = "dropdownMenuWidget svelte-15d1wql";
				addLoc(div_3, file$4, 3, 3, 138);
				div_2.className = "sidebarPanel-toolbarContainer svelte-15d1wql";
				addLoc(div_2, file$4, 2, 2, 91);
				i.className = "icon-bell";
				addLoc(i, file$4, 16, 6, 594);
				addLoc(span, file$4, 17, 6, 626);
				addListener(li, "click", click_handler_1);
				li.className = "dropdownMenuWidget-item svelte-15d1wql";
				addLoc(li, file$4, 15, 5, 516);
				i_1.className = "icon-eye";
				addLoc(i_1, file$4, 20, 6, 750);
				addLoc(span_1, file$4, 21, 6, 781);
				addListener(li_1, "click", click_handler_2);
				li_1.className = "dropdownMenuWidget-item checked svelte-15d1wql";
				addLoc(li_1, file$4, 19, 5, 670);
				ul.className = "dropdownMenuWidget right svelte-15d1wql";
				addLoc(ul, file$4, 14, 4, 473);
				textarea.className = "text-input hidden svelte-15d1wql";
				textarea.value = ctx.confStr;
				addLoc(textarea, file$4, 24, 4, 824);
				div_6.className = "view svelte-15d1wql";
				addLoc(div_6, file$4, 25, 4, 885);
				div_5.className = "editor svelte-15d1wql";
				addLoc(div_5, file$4, 13, 3, 448);
				div_4.className = "sidebarPanel-codeEditorContainer svelte-15d1wql";
				addLoc(div_4, file$4, 12, 2, 398);
				div_1.className = "sidebarPanel svelte-15d1wql";
				addLoc(div_1, file$4, 1, 1, 62);
				div.className = "editor-sidebarContainer editor_sidebarExpanded svelte-15d1wql";
				addLoc(div, file$4, 0, 0, 0);
				div_7.className = "editor-viewerContainer editor_sidebarExpanded";
				addLoc(div_7, file$4, 30, 0, 953);
			},
	...
	function create_each_block$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				span = createElement("span");
				text_1 = createText(text_1_value);
				i.className = i_class_value = "icon-" + ctx.it.name + " svelte-15d1wql";
				addLoc(i, file$4, 6, 5, 298);
				addLoc(span, file$4, 7, 5, 334);

				div._svelte = { component, ctx };

				addListener(div, "click", click_handler);
				div.className = div_class_value = "dropdownMenuWidget-item" + (ctx.it.checked ? ' checked' : '') + " svelte-15d1wql";
				addLoc(div, file$4, 5, 4, 202);
			},
			...
			p: function update(changed, _ctx) {
				ctx = _ctx;
				if ((changed.dropdownMenu) && i_class_value !== (i_class_value = "icon-" + ctx.it.name + " svelte-15d1wql")) {
				...
				div._svelte.ctx = ctx;
				if ((changed.dropdownMenu) && div_class_value !== (div_class_value = "dropdownMenuWidget-item" + (ctx.it.checked ? ' checked' : '') + " svelte-15d1wql")) {
