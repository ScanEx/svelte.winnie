var app = (function () {
	...
	function create_if_block_1(component, ctx) {
		...
		return {
			c: function create() {
				span = createElement("span");
				span.className = span_class_value = "" + ctx.type + " legendIconStyle " + " svelte-15ogcos";
			...
			p: function update(changed, ctx) {
				if ((changed.type) && span_class_value !== (span_class_value = "" + ctx.type + " legendIconStyle " + " svelte-15ogcos")) {
	...
	function create_main_fragment$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				li.className = li_class_value = "line cmd:toggleIcons id:" + ctx.nodeID + " svelte-1voql8z";
			...
			p: function update(changed, ctx) {
				...
				if ((!current || changed.nodeID) && li_class_value !== (li_class_value = "line cmd:toggleIcons id:" + ctx.nodeID + " svelte-1voql8z")) {
	...
	function create_if_block_3(component, ctx) {
		...
		return {
			c: function create() {
				...
				setAttribute(svg, "class", "svgIcon svelte-1voql8z");
				addLoc(svg, file$1, 8, 29, 550);
				span.className = "cont-overlays svelte-1voql8z";
	...
	function create_if_block_4(component, ctx) {
		...
		return {
			c: function create() {
				...
				span.className = "pointer cmd:showInfo cont-info svelte-1voql8z";
	...
	function create_if_block_2(component, ctx) {
		...
		return {
			c: function create() {
				...
				span_1.className = "pointer cmd:fitBounds cont-center svelte-1voql8z";
				span_1.title = "Move map to this layer";
				addLoc(span_1, file$1, 11, 3, 685);
				span.className = "icons  svelte-1voql8z";
	...
	function create_if_block_1$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				input.className = "expander expanderInput hidden svelte-1voql8z";
				...
				span.className = span_class_value = "expander pointer cmd:toggleFolder expanderCont " + (ctx.line.content.children ? '' : 'hidden') + " svelte-1voql8z";
			...
			p: function update(changed, ctx) {
				...
				if ((changed.line) && span_class_value !== (span_class_value = "expander pointer cmd:toggleFolder expanderCont " + (ctx.line.content.children ? '' : 'hidden') + " svelte-1voql8z")) {
					span.className = span_class_value;
				}
	...
	function create_if_block_6(component, ctx) {
		...
		return {
			c: function create() {
				...
				span = createElement("span");
				if (if_block) if_block.c();
				input.className = "check visibility pointer cmd:toggleVisibility svelte-1voql8z";
				setAttribute(input, "type", "checkbox");
				...
				span.className = "styleIcon gmx-style-legend svelte-1voql8z";
	...
	function create_each_block(component, ctx) {
		...
		return {
			c: function create() {
				...
				setAttribute(svg, "role", "img");
				setAttribute(svg, "class", "svgIcon on svelte-1voql8z");
				...
				setAttribute(svg_1, "class", "svgIcon off svelte-1voql8z");
				addLoc(svg_1, file$1, 37, 6, 2125);
				span.className = "legendIconEye enabled pointer cmd:toggleStyle svelte-1voql8z";
				addLoc(span, file$1, 35, 5, 1961);
				span_2.className = "styleName svelte-1voql8z";
				addLoc(span_2, file$1, 40, 34, 2332);
				span_1.className = "legendIconCell svelte-1voql8z";
				addLoc(span_1, file$1, 40, 5, 2303);
				div.className = "gmx-style-legend svelte-1voql8z";
	...
	function create_if_block_8(component, ctx) {
		...
		return {
			c: function create() {
				div = createElement("div");
				if (if_block) if_block.c();
				div.className = "legend svelte-1voql8z";
	...
	function create_if_block_5(component, ctx) {
		...
		return {
			c: function create() {
				...
				label.className = "pointer title cmd:toggleVisibility svelte-1voql8z";
				addLoc(label, file$1, 28, 2, 1607);
				div.className = "description collapse svelte-1voql8z";
	...
	function create_if_block_10(component, ctx) {
		...
		return {
			c: function create() {
				...
				ul.className = ul_class_value = "group css-treeview id_" + (ctx.properties ? ctx.properties.name : 'root') + " svelte-1voql8z";
			...
			p: function update(changed, ctx) {
				...
				if ((!current || changed.properties) && ul_class_value !== (ul_class_value = "group css-treeview id_" + (ctx.properties ? ctx.properties.name : 'root') + " svelte-1voql8z")) {
	...
	function create_main_fragment$4(component, ctx) {
		...
		return {
			c: function create() {
				...
				div = createElement("div");
				map._fragment.c();
				div.className = "editor-viewerContainer editor_sidebarExpanded svelte-lm68mo";
				addLoc(div, file$4, 32, 0, 1012);
			},
	...
	function create_each_block$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				span = createElement("span");
				text_1 = createText(text_1_value);
				i.className = i_class_value = "icon-" + ctx.it.name + " svelte-lm68mo";
				addLoc(i, file$4, 7, 5, 326);
				addLoc(span, file$4, 8, 5, 363);

				div._svelte = { component, ctx };

				addListener(div, "click", click_handler);
				div.className = div_class_value = "dropdownMenuWidget-item" + (ctx.it.checked ? ' checked' : '') + " svelte-lm68mo";
				addLoc(div, file$4, 6, 4, 229);
			},
			...
			p: function update(changed, ctx) {
				if ((changed.dropdownMenu) && i_class_value !== (i_class_value = "icon-" + ctx.it.name + " svelte-lm68mo")) {
				...
				div._svelte.ctx = ctx;
				if ((changed.dropdownMenu) && div_class_value !== (div_class_value = "dropdownMenuWidget-item" + (ctx.it.checked ? ' checked' : '') + " svelte-lm68mo")) {
	...
	function create_if_block$2(component, ctx) {
		...
		return {
			c: function create() {
				...
				div_3.className = "dropdownMenuWidget svelte-lm68mo";
				addLoc(div_3, file$4, 4, 3, 163);
				div_2.className = "sidebarPanel-toolbarContainer svelte-lm68mo";
				addLoc(div_2, file$4, 3, 2, 115);
				i.className = "icon-bell";
				addLoc(i, file$4, 17, 6, 632);
				addLoc(span, file$4, 18, 6, 665);
				addListener(li, "click", click_handler_1);
				li.className = "dropdownMenuWidget-item svelte-lm68mo";
				addLoc(li, file$4, 16, 5, 553);
				i_1.className = "icon-eye";
				addLoc(i_1, file$4, 21, 6, 792);
				addLoc(span_1, file$4, 22, 6, 824);
				addListener(li_1, "click", click_handler_2);
				li_1.className = "dropdownMenuWidget-item checked svelte-lm68mo";
				addLoc(li_1, file$4, 20, 5, 711);
				ul.className = "dropdownMenuWidget right svelte-lm68mo";
				addLoc(ul, file$4, 15, 4, 509);
				textarea.className = "text-input hidden svelte-lm68mo";
				textarea.value = ctx.confStr;
				addLoc(textarea, file$4, 25, 4, 870);
				div_6.className = "view svelte-lm68mo";
				addLoc(div_6, file$4, 26, 4, 932);
				div_5.className = "editor svelte-lm68mo";
				addLoc(div_5, file$4, 14, 3, 483);
				div_4.className = "sidebarPanel-codeEditorContainer svelte-lm68mo";
				addLoc(div_4, file$4, 13, 2, 432);
				div_1.className = "sidebarPanel svelte-lm68mo";
				addLoc(div_1, file$4, 2, 1, 85);
				div.className = "editor-sidebarContainer editor_sidebarExpanded svelte-lm68mo";
				addLoc(div, file$4, 1, 0, 22);
			},
