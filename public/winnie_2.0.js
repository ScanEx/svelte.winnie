var app = (function (leaflet) {
	...
	function onstate$2(ref) {
	    ...
	    if (changed.urlParams) {
	        var conf = current.urlParams.config || DEFAULT_CONFIG;
	...
	function create_main_fragment$5(component, ctx) {
		...
		return {
			c: function c() {
				...
				div.className = "editor-viewerContainer editor_sidebarExpanded svelte-1qc4ci9";
			},
	...
	function create_if_block_2$1(component, ctx) {
		...
		return {
			c: function c() {
				...
				text = createText("\r\n        ");
				div2 = createElement("div");
				div0.className = "dropdownMenuWidget svelte-1qc4ci9";
				div1.className = "sidebarPanel-toolbarContainer svelte-1qc4ci9";
				div2.id = "editor";
				div2.className = "editor svelte-1qc4ci9";
				div3.className = "sidebarPanel svelte-1qc4ci9";
				div4.className = "editor-sidebarContainer editor_sidebarExpanded svelte-1qc4ci9";
			},
	...
	function create_each_block$1(component, ctx) {
		...
		return {
			c: function c() {
				...
				i.className = i_class_value = "icon-" + ctx.it.name + " svelte-1qc4ci9";

				div._svelte = { component: component, ctx: ctx };

				addListener(div, "click", click_handler);
				div.className = div_class_value = "dropdownMenuWidget-item" + (ctx.it.checked ? ' checked' : '') + " svelte-1qc4ci9";
			},
			...
			p: function p(changed, _ctx) {
				ctx = _ctx;
				if ((changed.dropdownMenu) && i_class_value !== (i_class_value = "icon-" + ctx.it.name + " svelte-1qc4ci9")) {
				...
				div._svelte.ctx = ctx;
				if ((changed.dropdownMenu) && div_class_value !== (div_class_value = "dropdownMenuWidget-item" + (ctx.it.checked ? ' checked' : '') + " svelte-1qc4ci9")) {
					div.className = div_class_value;
				}
			},
