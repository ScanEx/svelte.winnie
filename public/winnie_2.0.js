var app = (function (leaflet) {
	...
	function create_if_block_9(component, ctx) {
		...
		return {
			c: function c() {
				...
				span0.innerHTML = "<svg role=\"img\" class=\"svgIcon svelte-t2dx67\"><use xlink:href=\"#center-on-click\" href=\"#center-on-click\"></use></svg>";
				text2 = createText("\n\t\t\t\n\t\t");
	...
	function create_if_block_11(component, ctx) {
		...
		return {
			c: function c() {
				span = createElement("span");
				span.innerHTML = "<svg role=\"img\" class=\"svgIcon svelte-t2dx67\"><use xlink:href=\"#info-circle-i\" href=\"#info-circle-i\"></use></svg>";
	...
	function create_if_block_10(component, ctx) {
		...
		return {
			c: function c() {
				span = createElement("span");
				span.innerHTML = "<svg role=\"img\" class=\"svgIcon svelte-t2dx67\"><use xlink:href=\"#timeline-icon\" href=\"#timeline-icon\"></use></svg>";
				addListener(span, "click", click_handler);
