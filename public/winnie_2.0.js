var app = (function (leaflet) {
	...
	function create_main_fragment$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				li.className = li_class_value = "line cmd:toggleIcons id:" + ctx.nodeID + " " + ctx.line.type + " svelte-1n507m0";
			...
			p: function update(changed, ctx) {
				...
				if ((!current || changed.nodeID || changed.line) && li_class_value !== (li_class_value = "line cmd:toggleIcons id:" + ctx.nodeID + " " + ctx.line.type + " svelte-1n507m0")) {
	...
	function create_if_block_13(component, ctx) {
		...
		return {
			c: function create() {
				...
				text = createText("\n\t");
				span = createElement("span");
				input.className = "expander expanderInput hidden svelte-1n507m0";
				setAttribute(input, "type", "checkbox");
				input.checked = ctx.isOpened;
				addLoc(input, file$1, 5, 1, 160);
				addListener(span, "click", click_handler);
				span.className = "expander pointer expanderCont cmd:clickOnExpander svelte-1n507m0";
	...
	function create_if_block_9(component, ctx) {
		...
		return {
			c: function create() {
				...
				setAttribute(svg, "class", "svgIcon svelte-1n507m0");
				addLoc(svg, file$1, 16, 83, 956);
				span0.className = "pointer cmd:fitBounds cont-center svelte-1n507m0";
				span0.title = "Move map to this layer";
				addLoc(span0, file$1, 16, 3, 876);
				span1.className = "icons  svelte-1n507m0";
	...
	function create_if_block_12(component, ctx) {
		...
		return {
			c: function create() {
				...
				span.className = "cont-overlays svelte-1n507m0";
	...
	function create_if_block_11(component, ctx) {
		...
		return {
			c: function create() {
				...
				addListener(span, "click", click_handler);
				span.className = "pointer cmd:showInfo cont-info svelte-1n507m0";
	...
	function create_if_block_10(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(use, file$1, 19, 125, 1332);
				setAttribute(svg, "role", "img");
				setAttribute(svg, "class", "svgIcon svelte-1n507m0");
				addLoc(svg, file$1, 19, 93, 1300);
				addListener(span, "click", click_handler);
				span.className = "pointer cmd:toggleTimeline timeline disabled svelte-1n507m0";
	...
	function create_if_block_2(component, ctx) {
		...
		return {
			c: function create() {
				...
				text5 = createText("\n\t\t");
				if (if_block2) if_block2.c();
				label.className = label_class_value = "pointer title cmd:" + (ctx.line.type === 'group' ? 'toggleGroup' : 'toggleVisibility') + " " + ctx.multiStyles + " svelte-1n507m0";
				addLoc(label, file$1, 36, 2, 2101);
				div.className = div_class_value = "description " + (ctx.properties.description ? '' : 'collapse') + " svelte-1n507m0";
				addLoc(div, file$1, 37, 2, 2238);
				span.className = "cont";
				addLoc(span, file$1, 25, 1, 1503);
			},
			...
			p: function update(changed, ctx) {
				...
				if ((!current || changed.line || changed.multiStyles) && label_class_value !== (label_class_value = "pointer title cmd:" + (ctx.line.type === 'group' ? 'toggleGroup' : 'toggleVisibility') + " " + ctx.multiStyles + " svelte-1n507m0")) {
				...
				if ((!current || changed.properties) && div_class_value !== (div_class_value = "description " + (ctx.properties.description ? '' : 'collapse') + " svelte-1n507m0")) {
	...
	function create_else_block$1(component, ctx) {
		...
		return {
			c: function create() {
				input = createElement("input");
				input.className = input_class_value = "check visibility pointer cmd:toggleVisibility " + ctx.line.type + " id:" + ctx.nodeID + " svelte-1n507m0";
				input.name = ctx.checkboxName;
				setAttribute(input, "type", ctx.checkboxType);
				input.checked = ctx.isVisible;
				addLoc(input, file$1, 31, 3, 1766);
			},
			...
			p: function update(changed, ctx) {
				if ((changed.line || changed.nodeID) && input_class_value !== (input_class_value = "check visibility pointer cmd:toggleVisibility " + ctx.line.type + " id:" + ctx.nodeID + " svelte-1n507m0")) {
	...
	function create_if_block_7(component, ctx) {
		...
		return {
			c: function create() {
				input = createElement("input");
				input.className = input_class_value = "check visibility pointer cmd:toggleGroup " + ctx.line.type + " id:" + ctx.nodeID + " svelte-1n507m0";
				input.name = ctx.checkboxName;
				setAttribute(input, "type", ctx.checkboxType);
				input.checked = ctx.isGroupVisible;
				addLoc(input, file$1, 28, 4, 1590);
			},
			...
			p: function update(changed, ctx) {
				if ((changed.line || changed.nodeID) && input_class_value !== (input_class_value = "check visibility pointer cmd:toggleGroup " + ctx.line.type + " id:" + ctx.nodeID + " svelte-1n507m0")) {
					input.className = input_class_value;
				}
	...
	function create_if_block_4(component, ctx) {
		...
		return {
			c: function create() {
				...
				div0.className = "legend-cont svelte-1n507m0";
				addLoc(div0, file$1, 41, 4, 2470);
				div1.className = "legend svelte-1n507m0";
				addLoc(div1, file$1, 40, 3, 2445);
			},
	...
	function create_each_block_1(component, ctx) {
		...
		return {
			c: function create() {
				...
				span1 = createElement("span");
				text2 = createText(text2_value);
				span0.className = "legendIconEye enabled pointer cmd:toggleStyle svelte-1n507m0";
				addLoc(span0, file$1, 44, 6, 2563);
				span1.className = "styleName svelte-1n507m0";
				addLoc(span1, file$1, 46, 6, 2703);
				div.className = "gmx-style-legend svelte-1n507m0";
				addLoc(div, file$1, 43, 5, 2526);
			},
	...
	function create_if_block$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				ul.className = ul_class_value = "group css-treeview id_" + ctx.nodeID + " " + (ctx.isOpened || ctx.isRoot ? '' : 'collapse') + " " + ctx.isRadio + " svelte-1n507m0";
				addLoc(ul, file$1, 59, 1, 2866);
			},
			...
			p: function update(changed, ctx) {
				...
				if ((!current || changed.nodeID || changed.isOpened || changed.isRoot || changed.isRadio) && ul_class_value !== (ul_class_value = "group css-treeview id_" + ctx.nodeID + " " + (ctx.isOpened || ctx.isRoot ? '' : 'collapse') + " " + ctx.isRadio + " svelte-1n507m0")) {
