var app = (function (leaflet) {
	...
	function create_main_fragment$1(component, ctx) {
		...
		return {
			c: function c() {
				...
				div.className = "mega";
				li.className = li_class_value = "line cmd:toggleIcons id:" + ctx.nodeID + " " + ctx.line.type + " svelte-nvxxr4";
			},
			...
			p: function p(changed, ctx) {
				...
				if ((!current || changed.nodeID || changed.line) && li_class_value !== (li_class_value = "line cmd:toggleIcons id:" + ctx.nodeID + " " + ctx.line.type + " svelte-nvxxr4")) {
	...
	function create_if_block_13(component, ctx) {
		...
		return {
			c: function c() {
				...
				text = createText("\r\n\t");
				span = createElement("span");
				input.className = "expander expanderInput hidden svelte-nvxxr4";
				setAttribute(input, "type", "checkbox");
				input.checked = ctx.isOpened;
				addListener(span, "click", click_handler);
				span.className = "expander pointer expanderCont cmd:clickOnExpander svelte-nvxxr4";
			},
	...
	function create_if_block_9(component, ctx) {
		...
		return {
			c: function c() {
				...
				span0.innerHTML = "<svg role=\"img\" class=\"svgIcon svelte-nvxxr4\"><use xlink:href=\"#center-on-click\" href=\"#center-on-click\"></use></svg>";
				text2 = createText("\r\n\t\t\t\r\n\t\t");
				if (if_block2) { if_block2.c(); }
				span0.className = "pointer cmd:fitBounds cont-center svelte-nvxxr4";
				span0.title = "Move map to this layer";
				span1.className = "icons  svelte-nvxxr4";
			},
	...
	function create_if_block_12(component, ctx) {
		...
		return {
			c: function c() {
				span = createElement("span");
				span.innerHTML = "<svg role=\"img\" class=\"svgIcon svelte-nvxxr4\"><use xlink:href=\"#overlays\" href=\"#overlays\"></use></svg>";
				span.className = "cont-overlays svelte-nvxxr4";
			},
	...
	function create_if_block_11(component, ctx) {
		...
		return {
			c: function c() {
				span = createElement("span");
				span.innerHTML = "<svg role=\"img\" class=\"svgIcon svelte-nvxxr4\"><use xlink:href=\"#info-circle-i\" href=\"#info-circle-i\"></use></svg>";
				span.className = "pointer cmd:showInfo cont-info svelte-nvxxr4";
	...
	function create_if_block_10(component, ctx) {
		...
		return {
			c: function c() {
				span = createElement("span");
				span.innerHTML = "<svg role=\"img\" class=\"svgIcon svelte-nvxxr4\"><use xlink:href=\"#timeline-icon\" href=\"#timeline-icon\"></use></svg>";
				addListener(span, "click", click_handler);
				span.className = "pointer cmd:toggleTimeline timeline disabled svelte-nvxxr4";
	...
	function create_if_block_2(component, ctx) {
		...
		return {
			c: function c() {
				...
				div.className = div_class_value = "description " + (ctx.properties.description ? '' : 'collapse') + " svelte-nvxxr4";
				span.className = "cont";
			},
			...
			p: function p(changed, ctx) {
				...
				if ((!current || changed.properties) && div_class_value !== (div_class_value = "description " + (ctx.properties.description ? '' : 'collapse') + " svelte-nvxxr4")) {
	...
	function create_else_block$1(component, ctx) {
		...
		return {
			c: function c() {
				input = createElement("input");
				input.className = input_class_value = "check visibility pointer cmd:toggleVisibility " + ctx.line.type + " id:" + ctx.nodeID + " svelte-nvxxr4";
			...
			p: function p(changed, ctx) {
				if ((changed.line || changed.nodeID) && input_class_value !== (input_class_value = "check visibility pointer cmd:toggleVisibility " + ctx.line.type + " id:" + ctx.nodeID + " svelte-nvxxr4")) {
	...
	function create_if_block_7(component, ctx) {
		...
		return {
			c: function c() {
				input = createElement("input");
				input.className = input_class_value = "check visibility pointer cmd:toggleGroup " + ctx.line.type + " id:" + ctx.nodeID + " svelte-nvxxr4";
				input.name = ctx.checkboxName;
				setAttribute(input, "type", ctx.checkboxType);
			...
			p: function p(changed, ctx) {
				if ((changed.line || changed.nodeID) && input_class_value !== (input_class_value = "check visibility pointer cmd:toggleGroup " + ctx.line.type + " id:" + ctx.nodeID + " svelte-nvxxr4")) {
					input.className = input_class_value;
				}
	...
	function create_if_block_4(component, ctx) {
		...
		return {
			c: function c() {
				...
				div0.className = "legend-cont svelte-nvxxr4";
				div1.className = "legend svelte-nvxxr4";
			},
	...
	function create_each_block_1(component, ctx) {
		...
		return {
			c: function c() {
				...
				span1 = createElement("span");
				text2 = createText(text2_value);
				span0.className = "legendIconEye enabled pointer cmd:toggleStyle svelte-nvxxr4";
				span1.className = "styleName svelte-nvxxr4";
				div.className = "gmx-style-legend svelte-nvxxr4";
			},
	...
	function create_if_block$1(component, ctx) {
		...
		return {
			c: function c() {
				...
				ul.className = ul_class_value = "group css-treeview id_" + ctx.nodeID + " " + (ctx.isOpened || ctx.isRoot ? '' : 'collapse') + " " + ctx.isRadio + " svelte-nvxxr4";
			},
			...
			p: function p(changed, ctx) {
				...
				if ((!current || changed.nodeID || changed.isOpened || changed.isRoot || changed.isRadio) && ul_class_value !== (ul_class_value = "group css-treeview id_" + ctx.nodeID + " " + (ctx.isOpened || ctx.isRoot ? '' : 'collapse') + " " + ctx.isRadio + " svelte-nvxxr4")) {
