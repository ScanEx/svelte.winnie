var app = (function (leaflet) {
	...
	function create_main_fragment$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				li.className = li_class_value = "line cmd:toggleIcons id:" + ctx.nodeID + " " + ctx.line.type + " svelte-tk2xxu";
			...
			p: function update(changed, ctx) {
				...
				if ((!current || changed.nodeID || changed.line) && li_class_value !== (li_class_value = "line cmd:toggleIcons id:" + ctx.nodeID + " " + ctx.line.type + " svelte-tk2xxu")) {
	...
	function create_if_block_13(component, ctx) {
		...
		return {
			c: function create() {
				...
				text = createText("\n\t");
				span = createElement("span");
				input.className = "expander expanderInput hidden svelte-tk2xxu";
				setAttribute(input, "type", "checkbox");
				input.checked = ctx.isOpened;
				addLoc(input, file$1, 5, 1, 160);
				addListener(span, "click", click_handler);
				span.className = "expander pointer expanderCont cmd:clickOnExpander svelte-tk2xxu";
	...
	function create_if_block_9(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(use, file$1, 16, 115, 988);
				setAttribute(svg, "role", "img");
				setAttribute(svg, "class", "svgIcon svelte-tk2xxu");
				addLoc(svg, file$1, 16, 83, 956);
				span0.className = "pointer cmd:fitBounds cont-center svelte-tk2xxu";
				span0.title = "Move map to this layer";
				addLoc(span0, file$1, 16, 3, 876);
				span1.className = "icons  svelte-tk2xxu";
				addLoc(span1, file$1, 12, 1, 600);
			},
	...
	function create_if_block_12(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(use, file$1, 10, 61, 525);
				setAttribute(svg, "role", "img");
				setAttribute(svg, "class", "svgIcon svelte-tk2xxu");
				addLoc(svg, file$1, 10, 29, 493);
				span.className = "cont-overlays svelte-tk2xxu";
				addLoc(span, file$1, 10, 1, 465);
			},
	...
	function create_if_block_11(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(use, file$1, 14, 137, 790);
				setAttribute(svg, "role", "img");
				setAttribute(svg, "class", "svgIcon svelte-tk2xxu");
				addLoc(svg, file$1, 14, 105, 758);
				addListener(span, "click", click_handler);
				span.className = "pointer cmd:showInfo cont-info svelte-tk2xxu";
				span.title = "View description";
				addLoc(span, file$1, 14, 2, 655);
			},
	...
	function create_if_block_10(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(use, file$1, 19, 146, 1353);
				setAttribute(svg, "role", "img");
				setAttribute(svg, "class", "svgIcon svelte-tk2xxu");
				addLoc(svg, file$1, 19, 114, 1321);
				addListener(span, "click", click_handler);
				span.className = "pointer cmd:toggleTimeline timeline disabled svelte-tk2xxu";
				span.title = "Add timeline";
				addLoc(span, file$1, 19, 2, 1209);
			},
	...
	function create_if_block_2(component, ctx) {
		...
		return {
			c: function create() {
				...
				text5 = createText("\n\t\t");
				if (if_block2) if_block2.c();
				label.className = label_class_value = "pointer title cmd:" + (ctx.line.type === 'group' ? 'toggleGroup' : 'toggleVisibility') + " " + ctx.multiStyles + " svelte-tk2xxu";
				addLoc(label, file$1, 36, 2, 2122);
				div.className = div_class_value = "description " + (ctx.properties.description ? '' : 'collapse') + " svelte-tk2xxu";
				addLoc(div, file$1, 37, 2, 2259);
				span.className = "cont";
				addLoc(span, file$1, 25, 1, 1524);
			},
			...
			p: function update(changed, ctx) {
				...
				if ((!current || changed.line || changed.multiStyles) && label_class_value !== (label_class_value = "pointer title cmd:" + (ctx.line.type === 'group' ? 'toggleGroup' : 'toggleVisibility') + " " + ctx.multiStyles + " svelte-tk2xxu")) {
				...
				if ((!current || changed.properties) && div_class_value !== (div_class_value = "description " + (ctx.properties.description ? '' : 'collapse') + " svelte-tk2xxu")) {
	...
	function create_else_block$1(component, ctx) {
		...
		return {
			c: function create() {
				input = createElement("input");
				input.className = input_class_value = "check visibility pointer cmd:toggleVisibility " + ctx.line.type + " id:" + ctx.nodeID + " svelte-tk2xxu";
				input.name = ctx.checkboxName;
				setAttribute(input, "type", ctx.checkboxType);
				input.checked = ctx.isVisible;
				addLoc(input, file$1, 31, 3, 1787);
			},
			...
			p: function update(changed, ctx) {
				if ((changed.line || changed.nodeID) && input_class_value !== (input_class_value = "check visibility pointer cmd:toggleVisibility " + ctx.line.type + " id:" + ctx.nodeID + " svelte-tk2xxu")) {
	...
	function create_if_block_7(component, ctx) {
		...
		return {
			c: function create() {
				input = createElement("input");
				input.className = input_class_value = "check visibility pointer cmd:toggleGroup " + ctx.line.type + " id:" + ctx.nodeID + " svelte-tk2xxu";
				input.name = ctx.checkboxName;
				setAttribute(input, "type", ctx.checkboxType);
				input.checked = ctx.isGroupVisible;
				addLoc(input, file$1, 28, 4, 1611);
			},
			...
			p: function update(changed, ctx) {
				if ((changed.line || changed.nodeID) && input_class_value !== (input_class_value = "check visibility pointer cmd:toggleGroup " + ctx.line.type + " id:" + ctx.nodeID + " svelte-tk2xxu")) {
					input.className = input_class_value;
				}
	...
	function create_if_block_4(component, ctx) {
		...
		return {
			c: function create() {
				...
				div0.className = "legend-cont svelte-tk2xxu";
				addLoc(div0, file$1, 41, 4, 2491);
				div1.className = "legend svelte-tk2xxu";
				addLoc(div1, file$1, 40, 3, 2466);
			},
	...
	function create_each_block_1(component, ctx) {
		...
		return {
			c: function create() {
				...
				span1 = createElement("span");
				text2 = createText(text2_value);
				span0.className = "legendIconEye enabled pointer cmd:toggleStyle svelte-tk2xxu";
				addLoc(span0, file$1, 44, 6, 2584);
				span1.className = "styleName svelte-tk2xxu";
				addLoc(span1, file$1, 46, 6, 2724);
				div.className = "gmx-style-legend svelte-tk2xxu";
				addLoc(div, file$1, 43, 5, 2547);
			},
	...
	function create_if_block$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				ul.className = ul_class_value = "group css-treeview id_" + ctx.nodeID + " " + (ctx.isOpened || ctx.isRoot ? '' : 'collapse') + " " + ctx.isRadio + " svelte-tk2xxu";
				addLoc(ul, file$1, 59, 1, 2887);
			},
			...
			p: function update(changed, ctx) {
				...
				if ((!current || changed.nodeID || changed.isOpened || changed.isRoot || changed.isRadio) && ul_class_value !== (ul_class_value = "group css-treeview id_" + ctx.nodeID + " " + (ctx.isOpened || ctx.isRoot ? '' : 'collapse') + " " + ctx.isRadio + " svelte-tk2xxu")) {
	...
	var methods$2 = {
		createMap(it) {
			...
			if(navigator.platform.match('Linux x86_64') !== null) {
