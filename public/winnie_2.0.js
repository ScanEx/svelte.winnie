var app = (function (leaflet) {
	...
	function create_if_block_9(component, ctx) {
		...
		return {
			c: function c() {
				...
				span0.innerHTML = "<svg role=\"img\" class=\"svgIcon svelte-1uracym\"><use xlink:href=\"#center-on-click\" href=\"#center-on-click\"></use></svg>";
				text2 = createText("\n\t\t\t\n\t\t");
	...
	function create_if_block_12(component, ctx) {
		...
		return {
			c: function c() {
				span = createElement("span");
				span.innerHTML = "<svg role=\"img\" class=\"svgIcon svelte-1uracym\"><use xlink:href=\"#overlays\" href=\"#overlays\"></use></svg>";
	...
	function create_if_block_11(component, ctx) {
		...
		return {
			c: function c() {
				span = createElement("span");
				span.innerHTML = "<svg role=\"img\" class=\"svgIcon svelte-1uracym\"><use xlink:href=\"#info-circle-i\" href=\"#info-circle-i\"></use></svg>";
	...
	function create_if_block_10(component, ctx) {
		...
		return {
			c: function c() {
				span = createElement("span");
				span.innerHTML = "<svg role=\"img\" class=\"svgIcon svelte-1uracym\"><use xlink:href=\"#timeline-icon\" href=\"#timeline-icon\"></use></svg>";
				addListener(span, "click", click_handler);
	...
	function create_if_block_2(component, ctx) {
		...
		return {
			c: function c() {
				...
				text5 = createText("\n\t\t");
				if (if_block2) { if_block2.c(); }
				label.className = label_class_value = "pointer title cmd:" + (ctx.line.type === 'group' ? 'toggleGroup' : 'toggleVisibility') + " " + ctx.multiStyles + " svelte-1uracym";
			...
			p: function p(changed, ctx) {
				...
				if ((!current || changed.line || changed.multiStyles) && label_class_value !== (label_class_value = "pointer title cmd:" + (ctx.line.type === 'group' ? 'toggleGroup' : 'toggleVisibility') + " " + ctx.multiStyles + " svelte-1uracym")) {
