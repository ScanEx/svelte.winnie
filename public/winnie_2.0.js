var app = (function (leaflet) {
	...
	function create_main_fragment$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				li.className = li_class_value = "line cmd:toggleIcons id:" + ctx.nodeID + " " + ctx.line.type + " svelte-137ivxp";
			...
			p: function update(changed, ctx) {
				...
				if ((!current || changed.nodeID || changed.line) && li_class_value !== (li_class_value = "line cmd:toggleIcons id:" + ctx.nodeID + " " + ctx.line.type + " svelte-137ivxp")) {
	...
	function create_if_block_13(component, ctx) {
		...
		return {
			c: function create() {
				...
				span.className = "expander pointer expanderCont cmd:clickOnExpander svelte-137ivxp";
	...
	function create_if_block_2(component, ctx) {
		var span, text0, text1, label, text2_value = ctx.properties.title, text2, label_class_value, text3, div, text4, current;
		...
		return {
			c: function create() {
				...
				text4 = createText("\n\t\t");
				if (if_block2) if_block2.c();
				label.className = label_class_value = "pointer title cmd:" + (ctx.line.type === 'group' ? 'toggleGroup' : 'toggleVisibility') + " " + ctx.multiStyles + " svelte-137ivxp";
			...
			p: function update(changed, ctx) {
				...
				if ((!current || changed.line || changed.multiStyles) && label_class_value !== (label_class_value = "pointer title cmd:" + (ctx.line.type === 'group' ? 'toggleGroup' : 'toggleVisibility') + " " + ctx.multiStyles + " svelte-137ivxp")) {
	...
	function create_else_block$1(component, ctx) {
		...
		return {
			c: function create() {
				input = createElement("input");
				input.className = input_class_value = "check visibility pointer cmd:toggleVisibility " + ctx.line.type + " id:" + ctx.nodeID + " svelte-137ivxp";
			...
			p: function update(changed, ctx) {
				if ((changed.line || changed.nodeID) && input_class_value !== (input_class_value = "check visibility pointer cmd:toggleVisibility " + ctx.line.type + " id:" + ctx.nodeID + " svelte-137ivxp")) {
	...
	function create_if_block_7(component, ctx) {
		...
		return {
			c: function create() {
				input = createElement("input");
				input.className = input_class_value = "check visibility pointer cmd:toggleGroup " + ctx.line.type + " id:" + ctx.nodeID + " svelte-137ivxp";
				input.name = ctx.checkboxName;
				setAttribute(input, "type", ctx.checkboxType);
			...
			p: function update(changed, ctx) {
				if ((changed.line || changed.nodeID) && input_class_value !== (input_class_value = "check visibility pointer cmd:toggleGroup " + ctx.line.type + " id:" + ctx.nodeID + " svelte-137ivxp")) {
					input.className = input_class_value;
				}
	...
	function create_if_block_4(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div0, file$1, 41, 4, 2406);
				div1.className = "legend svelte-137ivxp";
				addLoc(div1, file$1, 40, 3, 2381);
			},
	...
	function create_each_block_1(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(span0, file$1, 44, 6, 2499);
				span1.className = "styleName svelte-137ivxp";
				addLoc(span1, file$1, 46, 6, 2639);
				div.className = "gmx-style-legend svelte-137ivxp";
				addLoc(div, file$1, 43, 5, 2462);
			},
	...
	function create_if_block$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				ul.className = ul_class_value = "group css-treeview id_" + ctx.nodeID + " " + (ctx.isOpened || ctx.isRoot ? '' : 'collapse') + " " + ctx.isRadio + " svelte-137ivxp";
				addLoc(ul, file$1, 59, 1, 2802);
			},
			...
			p: function update(changed, ctx) {
				...
				if ((!current || changed.nodeID || changed.isOpened || changed.isRoot || changed.isRadio) && ul_class_value !== (ul_class_value = "group css-treeview id_" + ctx.nodeID + " " + (ctx.isOpened || ctx.isRoot ? '' : 'collapse') + " " + ctx.isRadio + " svelte-137ivxp")) {
