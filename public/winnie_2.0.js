	...
	function create_if_block_4(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div0, file$1, 41, 4, 2442);
				div1.className = "legend svelte-tk2xxu";
				addLoc(div1, file$1, 40, 3, 2417);
			},
	...
	function create_each_block_1(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(span0, file$1, 44, 6, 2535);
				span1.className = "styleName svelte-tk2xxu";
				addLoc(span1, file$1, 46, 6, 2675);
				div.className = "gmx-style-legend svelte-tk2xxu";
				addLoc(div, file$1, 43, 5, 2498);
			},
